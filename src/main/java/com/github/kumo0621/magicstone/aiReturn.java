...
public class aiReturn {
    ...
    public static void ai(String gamePlayer,Player player) {
        ...
        ChatMessage userMessage = new ChatMessage(ChatMessageRole.USER.value(),
                "次の文章の、採点を行って具体的な魔法の種類とステータスと、盛大な魔法名を決めてください。"+gamePlayer+"種類を、「"+magicList.magicActions+"」の中から近いものを絶対1つ決めてください。文章に応じて威力、効果時間、すべての数値を1~50の中で決める。文章に応じた、魔法名を決める。指定された値以外絶対に返さないでください。返答メッセージに余分なものはつけず、決めたものだけ書き出してください。JSON形式で、「{\"種類\":～,\"魔法名\":～,\"威力\":～,\"効果時間\":～}」また、意味のわからないものは、意味不明と返してください。また、指定のなかった値に関しては一律「5~15」の値を入れてください。");
